...
public class AiAnalysisController {
    ...
    public ApiResponse<AiAnalysisResponseDTO> requestAnalysis(
        ...
        AiAnalysisResponseDTO result = aiAnalysisService.requestAnalysis(userId, request);
    ...
    public ApiResponse<AiAnalysisResponseDTO> getAnalysisResult(
        ...
        Long userId = authenticatedUserResolver.resolveUserId(email);
        AiAnalysisResponseDTO result = aiAnalysisService.getAnalysisResult(userId, recordId);
    ...
    public ApiResponse<AiAnalysisStatusResponseDTO> getAnalysisStatus(
        ...
        Long userId = authenticatedUserResolver.resolveUserId(email);
        AiAnalysisStatusResponseDTO result = aiAnalysisService.getAnalysisStatus(userId, recordId);
        return ApiResponse.onSuccess(result);
    }
